...
export default function Menu({ children, onItemSelect }: { children?: ReactElement<MenuItemType, typeof MenuItem> | ReactElement<MenuItemType, typeof MenuItem>[], onItemSelect?: (id: string) => void }) {
