    ...
    return (<div className='max-w-lg mx-auto bg-gray-50'>
            ...
            <SplideTrack>
                <SplideSlide>
                    <div className="flex py-6 mx-2 ">
                        <div className="w-full aspect-[19/9] bg-gradient-to-r from-indigo-500 to-blue-500 rounded-3xl flex flex-row-reverse">
        ...
        <div>
            <div className="flex flex-row-reverse py-3">
                ...
                <div className='flex flex-1 flex-col justify-between py-1' onClick={() => { setOpen(true) }}>
        ...
        <Sheet isOpen={isOpen} disableDismiss={true} initialSnap={1} detent="content" snapPoints={snapPoints} onClose={() => setOpen(false)}>
            <Sheet.Container className='!rounded-t-2xl'>
                <Sheet.Header />
                <Sheet.Content><div className="flex bg-white rounded-3xl px-5 flex-col">
                    ...
                    <div><button className="w-full mb-6 mt-10 text-white bg-blue-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-sm px-5 py-4 me-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">افزودن به لیست انتظار</button></div>
