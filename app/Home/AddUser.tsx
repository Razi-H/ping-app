export default function AddUser() {
    return (
        <div className="flex bg-white rounded-3xl px-5 flex-col">
            ...
            <div><button className="w-full mb-6 mt-10 text-white bg-blue-500 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-xl text-sm px-5 py-3 me-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">افزودن به لیست انتظار</button></div>
