            ...
            <div className="flex bg-white rounded-3xl px-5 flex-col">
                <div className="mb-4 w-full py-2">
                    ...
                    {showPingTag && <div className="mt-4">
                        <input type="text" {...register("pingTag", { required: true })} className="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="تگ فراخوانی را وارد کنید" />
                    </div>}
